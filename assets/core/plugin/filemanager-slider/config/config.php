...
$base_url= "http://localhost/gm_ancient/";  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = 'wdc-uploads/slider/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../wdc-uploads/slider/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../wdc-uploads/slider/thumb/'; // relative path from filemanager folder to thumbs folder (with final /)
...
//**********************
$ext_img = array('jpg', 'jpeg', 'png', 'gif', 'swf', 'tiff', 'svg'); //Images
