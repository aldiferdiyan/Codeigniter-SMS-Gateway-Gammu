...
$upload_dir = '../wdc-uploads/berita/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../wdc-uploads/berita/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../wdc-uploads/berita/thumb/'; // relative path from filemanager folder to thumbs folder (with final /)
