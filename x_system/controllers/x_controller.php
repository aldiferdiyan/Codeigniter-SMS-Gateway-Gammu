...
class {nama_class} extends Core
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('{nama_class_lower}_model','model');
    }
    ...
    function index()
    {
        ...
        $this->load->view("{views}/main",$data);
    }
    ...
    function create()
    {
        ...
        {
            core::insert('{nama_table}','{nama_database}',{field_array});
            redirect('{nama_class_lower}');
        }
    }
    ...
    function update($id = '')
    {
        ...
        {
            core::update('{nama_table}','{nama_database}',{field_array},$this->input->post('id'));
            redirect('{nama_class_lower}');
        }
    }
    ...
    function delete($id = '')
    {
        core::delete('{nama_table}','{nama_database}',$id);
        redirect('{nama_class_lower}');
    }
